...
This ColdBox module provides a powerful `vite()` helper function for loading assets generated by Vite and the [`coldbox-vite-plugin`](https://www.npmjs.com/package/coldbox-vite-plugin). It intelligently handles both development (hot reload) and production (manifest-based) modes automatically.
...
This module is designed to work seamlessly with the [`coldbox-vite-plugin`](https://www.npmjs.com/package/coldbox-vite-plugin):
